...
from Auto48X.pytorch_quantization.nn import TensorQuantizer
from Auto48X.pytorch_quantization.tensor_quant import QuantDescriptor, QUANT_DESC_8BIT_PER_TENSOR
...
class QuantMixin():
    ...
    def init_quantizer(self, quant_desc_input, quant_desc_weight, num_layers=None):
        ...
        Args:
            quant_desc_input: An instance of :class:`QuantDescriptor
            <pytorch_quantization.tensor_quant.QuantDescriptor>`
            quant_desc_weight: An instance of :class:`QuantDescriptor
            <pytorch_quantization.tensor_quant.QuantDescriptor>`
