...
from Auto48X.pytorch_quantization import tensor_quant
from Auto48X.pytorch_quantization.nn._functions import quant_rnn
from . import _utils
...
class QuantRNNCell(QuantRNNCellBase):
    ...
    def __init__(self, input_size, hidden_size, bias=True, nonlinearity="tanh"):
        ...
        self.reset_quantrnncell_parameters()

    def reset_quantrnncell_parameters(self):
        stdv = 1.0 / math.sqrt(self.hidden_size)
        for weight in self.parameters():
            weight.data.uniform_(-stdv, stdv)
