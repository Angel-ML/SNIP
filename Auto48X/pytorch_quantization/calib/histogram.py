...
from Auto48X.pytorch_quantization.tensor_quant import fake_tensor_quant
from Auto48X.pytorch_quantization import nn as quant_nn
...
class HistogramCalibrator(_Calibrator):
    ...
    def collect(self, x):
        """Collect histogram"""
        if torch.min(x) < 0.:
            # logging.info("Calibrator encountered negative values. It shouldn't happen after ReLU. "
    ...
    def compute_amax(
        ...
        return calib_amax.to(self._device)
